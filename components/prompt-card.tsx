...
export function PromptCard({ prompt }: { prompt: ClubPrompt }) {
  ...
  function handleDownload(e: React.MouseEvent) {
    e.stopPropagation()
    const blob = new Blob([prompt.body_md], { type: 'text/markdown;charset=utf-8' })
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ fontSize: 22, flexShrink: 0, lineHeight: 1 }}>{prompt.emoji ?? '💬'}</span>
